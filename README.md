...
### Проект № 4. Инвестиционная платформа <a href="https://zorko-exchange.ru/">Zorko</a> 
...
<p>Что нужно было сделать: протестировать сайт инвестиционной платформы Zorko.<p>
  <li>Задача № 1. Составить чек-листы проверок.<p>Как решал: <a href="ссылка на чек-лист">чек-листы</a> составлял в Miro.</p></li>
...
<p>Итоги:<p>
<ol>
  <li>Нашел 12 багов (из них 2 блокера); <a href="ссылка на чек-лист">примеры найденных дефектов.</a></li>
